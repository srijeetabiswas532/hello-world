...
class Player(object):
    ...
    def __str__(self):
        ...
        for i in range(len(self.cards)):
            holdString += str(self.cards[i]) + ' '
        return holdString + '-' + ' ' + str(self.get_points()) + ' ' + 'Points'
...
class Blackjack(object):
    ...
    def play(self):
        ...
        for x in range(self.num_players):
            if (self.player_list[x].has_blackjack()):
                print('Player ' + str(x+1) + ' wins')
            elif (player_points[x] > 21):
                print('Player ' + str(x+1) + ' loses')
            elif (dealer_points <= 21) and (dealer_points > player_points[x]):
                print('Player ' + str(x+1) + ' loses')
            elif (dealer_points < player_points[x]) and (player_points[x] <= 21):
                print('Player ' + str(x+1) + ' wins')
